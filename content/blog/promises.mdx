...
date: '2019-12-21'
description: 'Aprende cómo funciona internamente el código asíncrono en Javascript y como manejar este con funcionalidades modernas como promesas y async await.'
...
export const promisesQuery = graphql`
  query promisesQuery($pagePath: String!) {
