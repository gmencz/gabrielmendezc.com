...
export type SitePluginPluginOptionsGatsbyRemarkPluginsOptions = {
  ...
  inlineCodeMarker?: Maybe<SitePluginPluginOptionsGatsbyRemarkPluginsOptionsInlineCodeMarker>,
...
export type SitePluginPluginOptionsGatsbyRemarkPluginsOptionsFilterInput = {
  inlineCodeMarker?: Maybe<SitePluginPluginOptionsGatsbyRemarkPluginsOptionsInlineCodeMarkerFilterInput>,
  aliases?: Maybe<SitePluginPluginOptionsGatsbyRemarkPluginsOptionsAliasesFilterInput>,
};

export type SitePluginPluginOptionsGatsbyRemarkPluginsOptionsInlineCodeMarker = {
   __typename?: 'SitePluginPluginOptionsGatsbyRemarkPluginsOptionsInlineCodeMarker',
  tsx?: Maybe<Scalars['String']>,
  js?: Maybe<Scalars['String']>,
};

export type SitePluginPluginOptionsGatsbyRemarkPluginsOptionsInlineCodeMarkerFilterInput = {
  tsx?: Maybe<StringQueryOperatorInput>,
  js?: Maybe<StringQueryOperatorInput>,
};
...
export type Listing_QueryQueryVariables = {};


export type Listing_QueryQuery = (
  { __typename?: 'Query' }
  & { allMdx: (
    { __typename?: 'MdxConnection' }
    & { edges: Array<(
      ...
      & { node: (
        ...
        & { frontmatter: Maybe<(
          { __typename?: 'MdxFrontmatter' }
          & Pick<MdxFrontmatter, 'path' | 'title' | 'date'>
        )> }
      ) }
    )> }
  ) }
